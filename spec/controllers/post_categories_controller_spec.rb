  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved post_category as @post_category" do
        ...
        post :create, {:post_category => { "name" => "invalid value" }}, valid_session
        assigns(:post_category).should be_a_new(PostCategory)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested post_category" do
        ...
        PostCategory.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => post_category.to_param, :post_category => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the post_category as @post_category" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        PostCategory.any_instance.stub(:save).and_return(false)
        put :update, {:id => post_category.to_param, :post_category => { "name" => "invalid value" }}, valid_session
        assigns(:post_category).should eq(post_category)
      end
